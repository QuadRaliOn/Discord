...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Poppins:300,regular,500,600,800" rel="stylesheet" />
    <title>Discord</title>
</head>
        ...
        <header class="header">
            <div class="header__container _container">
                <a href="" class="header__logo">
                    <svg class="logo-ds" width="124" height="34" viewBox="0 0 124 34">
                        <g fill="currentColor">
                            <path
                ...
                <nav class="header__menu menu">
                    <ul class="menu__list">
                        ...
                        <li class="menu__item"><a href="" class="menu__link">Nitro</a></li>
                        <li class="menu__item"><a href="" class="menu__link">Discover</a></li>
                        <li class="menu__item"><a href="" class="menu__link">Safety</a></li>
                ...
                <div class="header__wrapper">
                    <div class="header_btn">
                        <a href="" class="header__button button button_small-header">Login</a>
                    </div>
        ...
        <main class="page">
                ...
                <div class="main__container">
                    <div class="main__content">
                        <div class="main__header header-main">
                            <h1 class="header-main__title title_white">
                                IMAGINE A PLACE...
                            </h1>
                            <div class="header-main__text text-white">
                        ...
                        <div class="main__actions">
                            <a href="" class="main__button button button_light"><svg width="24" height="24"
                                ...
                                </svg> Download for Windows</a>
                            <a href="" class="main__button button button_dark">Open Discord in your browser</a>
                        </div>
                    </div>

                    <div class="main__background">
                        <img class="bg-center" src="images/header/bg-mount.svg" alt="">
                        <img class="bg-right" src="images/header/bg-right.svg" alt="">
                        <img class="bg-left" src="images/header/bg-left.svg" alt="">
                    </div>
                </div>
            ...
            <section class="page__create create">
                <div class="create__container">
                    <div class="create__image img">
                        <img src="images/section2.svg" alt="">
                    </div>
                    <div class="main__header header-main content">
            ...
            <section class="page_hangout hangout">
                <div class="hangout__container">
                    <div class="hangout_image img">
            ...
            <section class="page_community community">
                <div class="community__container">
                    <div class="community_image img">
                        <img src="images/section4.svg" alt="">
                    </div>
                    <div class="main__header header-main">
                        <h2 class="header-main__title">
            ...
            <section class="page_tech tech">
                <div class="tech__container">
                    <div class="tech_image img">
                    ...
                    <div class="main__header header-main">
                        ...
                        <div class="header-main__text text-tech">
                            Low-latency voice and video feels like you’re in the same room. Wave hello over video, watch
                            friends stream their games, or gather up and have a drawing session with screen share.
                        </div>
                    </div>
                </div>
            </section>
            <div class="page_start start">
                <div class="start__container">
                    <div class="start__header">
                        <div class="start__title">Ready to start your journey?</div>
                        <img src="images/section5_decor.svg" alt="">
                    </div>
                    <div class="start_btn">
                        <a href="" class="start__button button"> <svg width="24" height="24" viewBox="0 0 24 24"
                                class="icon-2tQ9Jt">
                                <g fill="currentColor">
                                    <path
                                        d="M17.707 10.708L16.293 9.29398L13 12.587V2.00098H11V12.587L7.70697 9.29398L6.29297 10.708L12 16.415L17.707 10.708Z">
            ...
            <div class="footer__container">
                <div class="footer__top">
                    ...
                    <div class="footer__column">
                        ...
                        <nav class="footer__menu menu-footer">
                            <ul class="menu-footer__list">
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Download</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Nitro</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Status</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">App Directory</a>
                                </div>
                            </ul>
                        </nav>
                    </div>
                    <div class="footer__column">
                        ...
                        <nav class="footer__menu menu-footer">
                            <ul class="menu-footer__list">
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">About</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Jobs</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Brand</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Newsroom</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Fall Release</a>
                                </div>
                            </ul>
                        </nav>
                    </div>
                    <div class="footer__column">
                        ...
                        <nav class="footer__menu menu-footer">
                            <ul class="menu-footer__list">
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">College</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Support</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Safety</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Blog</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Feedback</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Developers</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">StreamKit</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Creators</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Community</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Official3rd Party
                                        Merch</a></div>
                            </ul>
                        </nav>
                    </div>
                    <div class="footer__column">
                        ...
                        <nav class="footer__menu menu-footer">
                            <ul class="menu-footer__list">
                                ...
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Cookie Settings</a>
                                </div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Guidelines</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Acknowledgements</a>
                                </div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Licenses</a></div>
                                <div class="menu-footer__item"><a href="" class="menu-footer__link">Company
                                        Information</a></div>
                    </div>
                    </ul>
                    </nav>
                ...
                <div class="footer__bottom">
                    <a class="logo-ds" href="">
                        <svg width="124" height="34" viewBox="0 0 124 34" class="logo-TA52YN">
                            <g fill="currentColor">
                                <path
                                    d="M26.0015 6.9529C24.0021 6.03845 21.8787 5.37198 19.6623 5C19.3833 5.48048 19.0733 6.13144 18.8563 6.64292C16.4989 6.30193 14.1585 6.30193 11.8336 6.64292C11.6166 6.13144 11.2911 5.48048 11.0276 5C8.79575 5.37198 6.67235 6.03845 4.6869 6.9529C0.672601 12.8736 -0.41235 18.6548 0.130124 24.3585C2.79599 26.2959 5.36889 27.4739 7.89682 28.2489C8.51679 27.4119 9.07477 26.5129 9.55525 25.5675C8.64079 25.2265 7.77283 24.808 6.93587 24.312C7.15286 24.1571 7.36986 23.9866 7.57135 23.8161C12.6241 26.1255 18.0969 26.1255 23.0876 23.8161C23.3046 23.9866 23.5061 24.1571 23.7231 24.312C22.8861 24.808 22.0182 25.2265 21.1037 25.5675C21.5842 26.5129 22.1422 27.4119 22.7621 28.2489C25.2885 27.4739 27.8769 26.2959 30.5288 24.3585C31.1952 17.7559 29.4733 12.0212 26.0015 6.9529ZM10.2527 20.8402C8.73376 20.8402 7.49382 19.4608 7.49382 17.7714C7.49382 16.082 8.70276 14.7025 10.2527 14.7025C11.7871 14.7025 13.0425 16.082 13.0115 17.7714C13.0115 19.4608 11.7871 20.8402 10.2527 20.8402ZM20.4373 20.8402C18.9183 20.8402 17.6768 19.4608 17.6768 17.7714C17.6768 16.082 18.8873 14.7025 20.4373 14.7025C21.9717 14.7025 23.2271 16.082 23.1961 17.7714C23.1961 19.4608 21.9872 20.8402 20.4373 20.8402Z">
                                </path>
                    ...
                    <a href="" class="footer__button button button_small-footer">Sign up</a>
                </div>
            </div>
    </div>
    </footer>
